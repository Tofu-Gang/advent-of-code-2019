...
def puzzle_01() -> int:
    ...
    :return: Answer should be 1855.
    """

    password = PasswordRange(RANGE_START, RANGE_END)
    result = password.valid_passwords_count(password.is_password_valid_1)
...
def puzzle_02() -> int:
    ...
    :return: Answer should be 1253.
    """

    password = PasswordRange(RANGE_START, RANGE_END)
    result = password.valid_passwords_count(password.is_password_valid_2)
    print_puzzle_solution(result)
    return result
