...
from src.day_08.space_image import SpaceImage
...
def puzzle_01() -> int:
    ...
    :return: Answer should be 2064.
    """

    with open(INPUT_FILE_PATH, "r") as f:
        image = SpaceImage(IMAGE_WIDTH, IMAGE_HEIGHT, f.read().strip())
